...
namespace Promix.Financials.Infrastructure.Migrations
{
    ...
    [Migration("20260412214907_AddFinancialPeriodsAndJournalStabilization")]
    partial class AddFinancialPeriodsAndJournalStabilization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Promix.Financials.Domain.Accounting.FinancialPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompanyId", "FinancialYearId", "Code")
                        .IsUnique();

                    b.HasIndex("CompanyId", "FinancialYearId", "StartDate", "EndDate")
                        .IsUnique();
            ...
            modelBuilder.Entity("Promix.Financials.Domain.Aggregates.Journals.JournalEntry", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "FinancialYearId", "Type", "EntryNumber");
            ...
            modelBuilder.Entity("Promix.Financials.Domain.Accounting.FinancialPeriod", b =>
                {
                    b.HasOne("Promix.Financials.Domain.Accounting.FinancialYear", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Promix.Financials.Domain.Aggregates.Journals.JournalEntry", b =>
                {
                    b.HasOne("Promix.Financials.Domain.Accounting.FinancialPeriod", null)
                        .WithMany()
